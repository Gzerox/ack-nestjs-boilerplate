...
import { TermsPolicyDoc } from '../repository/entities/terms-policy.entity';
import { REQUEST } from '@nestjs/core';
import { IRequestApp } from '@common/request/interfaces/request.interface';

@Injectable({ scope: Scope.REQUEST })
export class TermsPolicyActiveParsePipe implements PipeTransform {
    constructor(
