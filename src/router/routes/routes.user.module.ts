...
import { TermsPolicyAuthController } from '@modules/terms-policy/controllers/terms-policy.auth.controller';

@Module({
    controllers: [UserUserController, VerificationUserController,TermsPolicyAuthController],
    providers: [],
    exports: [],
    imports: [
        UserModule,
